...
class DigitalLibrary {
    ...
    static String adminId = "Kanishkaa@123";
    static String adminPass = "pass@123";

    public static void main(String[] args) {
        books.put("B001", "Twisted Love");
        books.put("B002", "The Haunting of Hill House");
        books.put("B003", "Gone Girl");
